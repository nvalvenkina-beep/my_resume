...
import workshopImg from "@assets/ai-workshop-speaker.png";
        ...
        <div className="space-y-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <img
                src={workshopImg}
                alt="Слайд выступления: практико-рефлексивный тренажёр — от методологии к вайбкодингу"
                className="relative z-10 w-full object-cover border border-white/10"
              />
            </motion.div>
            ...
            >
              <div className="w-16 h-1.5 bg-primary mb-8" />
              <p className="text-3xl md:text-4xl font-display font-black leading-tight mb-6">
                Спикер ИИ-мастерской eLearning Center
              </p>
              <p className="text-gray-400 text-lg leading-relaxed">
                Выступила с&nbsp;кейсом «Создание практико-рефлексивного тренажёра для&nbsp;онлайн-курса: от&nbsp;методологии к&nbsp;вайбкодингу», представив собственную практику применения ИИ и&nbsp;вайбкодинга в&nbsp;разработке тренажёров для&nbsp;онлайн-курса.
              </p>
            </motion.div>
          </div>
        </div>
